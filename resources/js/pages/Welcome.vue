...
<template>
    ...
    >
        ...
        >
            <nav class="d-flex align-center justify-end ga-4">
                <Link
            ...
            >
                ...
                <div
                    ...
                    :style="{
                        ...
                        'aspect-ratio': $vuetify.display.lgAndUp ? 'auto' : '335/376',
                ...
                >
                    ...
                    <svg
                        ...
                        :style="{
                            ...
                            'margin-left': $vuetify.display.lgAndUp ? '0' : '-2rem'
                        }"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <g
                            class="opacity-100"
                            style="transform: translateY(0); transition: all 750ms; transition-delay: 300ms;"
                        >
                            <path
        ...
        <div 
            class="d-none"
            :class="{ 'd-lg-block': $vuetify.display.lgAndUp }"
            style="height: 58px;"
        ></div>
    </div>
</template>
