...
// State
const { rail, mobile, open, setMobile } = useSidebar();
const page = usePage();
        ...
        <v-list class="pa-2" density="compact" nav>
            <template v-for="(item, i) in mainNavItems" :key="i">
                ...
                <v-list-item
                    ...
                    :active="isUrlActive(item.href)"
                    :variant="isUrlActive(item.href) ? 'tonal' : 'text'"
                    color="primary"
                    rounded="md"
                    class="mb-1"
                    @click.prevent="$inertia.visit(getHref(item.href))"
                >
                    <template #prepend>
                ...
                <v-list-group v-else :value="item.title">
                    ...
                    <v-list-item
                        ...
                        :active="isUrlActive(subItem.href)"
                        :variant="isUrlActive(subItem.href) ? 'tonal' : 'text'"
                        color="primary"
                        rounded="md"
                        class="mb-1 ml-4"
                    >
        ...
        <template #append>
            <div class="pa-2">
                ...
                <v-list density="compact" nav class="mb-2">
                    <v-list-item
                        v-for="(item, i) in footerNavItems"
                        :key="i"
                        :href="getHref(item.href)"
                        target="_blank"
                        rounded="md"
                ...
                <!-- User Menu -->
                <v-menu
                    :location="rail && !isMobile ? 'end' : 'bottom'"
                    offset="8"
                    min-width="224"
                >
                    <template #activator="{ props }">
